...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// Text_Email
			// 
			this->Text_Email->Location = System::Drawing::Point(290, 383);
			...
			this->label10->Location = System::Drawing::Point(122, 388);
			...
			// Text_Contact
			// 
			this->Text_Contact->Location = System::Drawing::Point(290, 340);
			...
			this->label9->Location = System::Drawing::Point(119, 345);
			...
			// Text_Address
			// 
			this->Text_Address->Location = System::Drawing::Point(290, 294);
			...
			this->label8->Location = System::Drawing::Point(119, 299);
			...
			// Text_ID_Proof
			// 
			this->Text_ID_Proof->Location = System::Drawing::Point(290, 256);
			...
			this->label7->Location = System::Drawing::Point(119, 259);
			...
			this->Text_Birth->Location = System::Drawing::Point(290, 218);
			...
			this->label6->Location = System::Drawing::Point(119, 218);
			...
			this->Text_Gender->Location = System::Drawing::Point(290, 168);
			...
			this->label5->Location = System::Drawing::Point(119, 168);
			...
			this->Text_Join->Location = System::Drawing::Point(290, 130);
			...
			this->label4->Location = System::Drawing::Point(119, 130);
			...
			// Text_Desig
			// 
			this->Text_Desig->Location = System::Drawing::Point(290, 88);
			...
			this->label3->Location = System::Drawing::Point(119, 88);
			...
			this->Text_Name->Location = System::Drawing::Point(290, 15);
			...
			this->label2->Location = System::Drawing::Point(119, 15);
			...
			this->Text_ID->Location = System::Drawing::Point(290, 48);
			...
			this->label1->Location = System::Drawing::Point(119, 48);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(290, 459);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(182, 31);
			...
			this->button2->Size = System::Drawing::Size(182, 31);
