...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 try
				 {
					 ...
					 String ^ insert_booking = "insert into Booking_Request([Customer_Username],[Customer_Type],[Customer_Name],[Date_From],[Date_Upto],[Room_Type],[Contact_Number],[Email],[Approved]) VALUES('" +customer_username+ "', '" +customer_type+ "', '" +customer_name+ "', '" +start_date+ "', '" +end_date+ "', '" +room_type+ "', '" +customer_contact+ "', '" +customer_email+ "', 'NO' );";
