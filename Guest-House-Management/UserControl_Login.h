...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// Txt_email
			// 
			this->Txt_email->Font = (gcnew System::Drawing::Font(L"Century Gothic", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->Txt_email->Location = System::Drawing::Point(335, 165);
			this->Txt_email->Margin = System::Windows::Forms::Padding(2);
			this->Txt_email->Name = L"Txt_email";
			this->Txt_email->Size = System::Drawing::Size(170, 27);
			...
			this->Lbl_username->Size = System::Drawing::Size(64, 24);
			this->Lbl_username->TabIndex = 36;
			this->Lbl_username->Text = L"Email";
			// 
			// UserControl_Login
			// 
...
#pragma endregion
	private: System::Void Btn_submit_Click(System::Object^  sender, System::EventArgs^  e) {
			...
			String ^ getUserData = "Select * from User_Table where [Email] = '" + email + "';";
			...
			else
			{
				...
				{	
					...
					else
					{
						...
						MessageBox::Show("Other Login Successful!");
						//this->Visible = false;
						Form_Reception ^form2 = gcnew Form_Reception();
						form2->ShowDialog();
					}
