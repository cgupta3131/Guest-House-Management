...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// Btn_All_Feedback
			// 
			this->Btn_All_Feedback->Location = System::Drawing::Point(112, 42);
			this->Btn_All_Feedback->Name = L"Btn_All_Feedback";
			this->Btn_All_Feedback->Size = System::Drawing::Size(152, 64);
			...
			// Btn_Unread_Feedback
			// 
			this->Btn_Unread_Feedback->Location = System::Drawing::Point(363, 42);
			this->Btn_Unread_Feedback->Name = L"Btn_Unread_Feedback";
			this->Btn_Unread_Feedback->Size = System::Drawing::Size(152, 64);
			...
			// Btn_Read_Feedback
			// 
			this->Btn_Read_Feedback->Location = System::Drawing::Point(625, 42);
			this->Btn_Read_Feedback->Name = L"Btn_Read_Feedback";
			this->Btn_Read_Feedback->Size = System::Drawing::Size(152, 64);
...
#pragma endregion
	...
	private: System::Void Btn_Read_Feedback_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 DB_Connection->ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=GuestHouse.accdb";
				 DB_Connection->Open();
				 String ^ getFeedbackData = "Select * from [Booking_Request] Where [Status_Feedback]='Read' AND [Approved]='YES';";
...
private: System::Void Btn_Unread_Feedback_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 DB_Connection->ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=GuestHouse.accdb";
			 DB_Connection->Open();
			 String ^ getFeedbackData = "Select * from [Booking_Request] Where [Status_Feedback]='Unread'  AND [Approved]='YES';";
			 ...
			 while(feedback_data->Read() == true)
			 {
				 ...
				 box->Checked = false;
				 box->Location = System::Drawing::Point(300,100*(i+1));
				 box->Name = "Checkbox" + i;
			 ...
			 btn->Location = System::Drawing::Point(40,100*(i+1));
...
private: System::Void Btn_All_Feedback_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 DB_Connection->ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=GuestHouse.accdb";
			 DB_Connection->Open();
			 String ^ getFeedbackData = "Select * from [Booking_Request] where [Approved]='YES';";
